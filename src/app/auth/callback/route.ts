...
/**
 * OpenAI/Codex OAuth callback handler.
 *
 * This route lives at /auth/callback to match the redirect URI registered
 * with the Codex CLI OAuth client (app_EMoamEEZ73f0CkXaXp7hrann).
 * The Codex CLI uses http://localhost:{port}/auth/callback as its redirect.
 */
